...
export function TechnicalFormsPage() {
  return (
    <div style={{ padding: 24, minHeight: '100%', background: '#F8FAFC', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ textAlign: 'center', maxWidth: 380 }}>
        <div style={{ width: 64, height: 64, borderRadius: 20, background: 'rgba(79,70,230,0.08)', border: '1px solid rgba(79,70,230,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 20px' }}>
          <FileText size={28} color="#4f46e6" />
        </div>
        <h1 style={{ fontSize: 22, fontWeight: 800, color: '#1C1C1E', marginBottom: 8 }}>Technical Forms</h1>
        ...
        <p style={{ fontSize: 13, color: '#94A3B8', lineHeight: 1.6 }}>
          Digital technical forms for machinery inspections, safety checklists, and maintenance reports.
          This module will allow crews to fill and submit standardized forms directly from the PMS.
        </p>
        <div style={{ marginTop: 20, padding: '12px 16px', background: '#fff', borderRadius: 12, border: '1px solid rgba(0,0,0,0.06)', textAlign: 'left' }}>
          ...
          {['Machinery Inspection Forms', 'Safety Check Checklists', 'Condition Report Templates', 'Pre-departure Inspection Forms', 'Class Survey Preparation Forms'].map(f => (
